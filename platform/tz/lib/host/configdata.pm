...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "-fPIC", "-mcpu=cortex-a73.cortex-a53+crypto", "-mtune=cortex-a73.cortex-a53", "-march=armv8-a+crc+simd+crypto", "-Os", "-include", "/home/hwlee/devel/rpi/edge-libevent/include/debug.h", "-include", "/home/hwlee/devel/rpi/edge-libevent/src/logger/seed_names.h", "-include", "/home/hwlee/devel/rpi/edge-libevent/src/logger/seed_flags.h" ],
  CPPDEFINES => [ "OPENSSL_SMALL_FOOTPRINT", "TIME_LOG" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/home/hwlee/devel/rpi/toolchains/aarch64/bin/aarch64-linux-gnu-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "-fPIC", "-mcpu=cortex-a73.cortex-a53+crypto", "-mtune=cortex-a73.cortex-a53", "-march=armv8-a+crc+simd+crypto", "-Os", "-include", "/home/hwlee/devel/rpi/edge-libevent/include/debug.h", "-include", "/home/hwlee/devel/rpi/edge-libevent/src/logger/seed_names.h", "-include", "/home/hwlee/devel/rpi/edge-libevent/src/logger/seed_flags.h" ],
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "engines/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md4/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/mdc2/build.info", "crypto/hmac/build.info", "crypto/ripemd/build.info", "crypto/whrlpool/build.info", "crypto/poly1305/build.info", "crypto/blake2/build.info", "crypto/siphash/build.info", "crypto/sm3/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/rc2/build.info", "crypto/rc4/build.info", "crypto/idea/build.info", "crypto/aria/build.info", "crypto/bf/build.info", "crypto/cast/build.info", "crypto/camellia/build.info", "crypto/seed/build.info", "crypto/sm4/build.info", "crypto/chacha/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/ec/build.info", "crypto/rsa/build.info", "crypto/dh/build.info", "crypto/sm2/build.info", "crypto/dso/build.info", "crypto/engine/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/comp/build.info", "crypto/ocsp/build.info", "crypto/ui/build.info", "crypto/ts/build.info", "crypto/srp/build.info", "crypto/cmac/build.info", "crypto/ct/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  ...
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_CMS", "OPENSSL_NO_DSA", "OPENSSL_NO_MD2", "OPENSSL_NO_RC5" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DSO", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_RDRAND", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "--cross-compile-prefix=/home/hwlee/devel/rpi/toolchains/aarch64/bin/aarch64-linux-gnu- --prefix=/home/hwlee/drive/openssl-1.1.1-host-aarch64 -fPIC -mcpu=cortex-a73.cortex-a53+crypto -mtune=cortex-a73.cortex-a53 -march=armv8-a+crc+simd+crypto -DOPENSSL_SMALL_FOOTPRINT -Os -include /home/hwlee/devel/rpi/edge-libevent/include/debug.h -include /home/hwlee/devel/rpi/edge-libevent/src/logger/seed_names.h -include /home/hwlee/devel/rpi/edge-libevent/src/logger/seed_flags.h -DTIME_LOG no-afalgeng no-asan no-buildtest-c++ no-cms no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dsa no-dso no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-rdrand no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.22.1",
  perlargv => [ "linux-aarch64", "--cross-compile-prefix=/home/hwlee/devel/rpi/toolchains/aarch64/bin/aarch64-linux-gnu-", "--prefix=/home/hwlee/drive/openssl-1.1.1-host-aarch64", "-fPIC", "-mcpu=cortex-a73.cortex-a53+crypto", "-mtune=cortex-a73.cortex-a53", "-march=armv8-a+crc+simd+crypto", "no-cms", "no-dsa", "no-rdrand", "-DOPENSSL_SMALL_FOOTPRINT", "no-dso", "-Os", "-include", "/home/hwlee/devel/rpi/edge-libevent/include/debug.h", "-include", "/home/hwlee/devel/rpi/edge-libevent/src/logger/seed_names.h", "-include", "/home/hwlee/devel/rpi/edge-libevent/src/logger/seed_flags.h", "-DTIME_LOG" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/home/hwlee/drive/openssl-1.1.1-host-aarch64",
  processor => "",
  rc4_int => "unsigned char",
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "idea", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dh", "sm2", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
    ...
    "depends" =>
        {
            ...
            "test/buildtest_c_logger" =>
                [
                    "libcrypto",
                    "libssl",
                ],
            "test/buildtest_c_logs" =>
                [
                    "libcrypto",
                    "libssl",
                ],
    ...
    "generate" =>
        {
            ...
            "test/buildtest_logger.c" =>
                [
                    "test/generate_buildtest.pl",
                    "logger",
                ],
            "test/buildtest_logs.c" =>
                [
                    "test/generate_buildtest.pl",
                    "logs",
                ],
    ...
    "includes" =>
        {
            ...
            "test/buildtest_logger.o" =>
                [
                    "include",
                ],
            "test/buildtest_logs.o" =>
                [
                    "include",
                ],
