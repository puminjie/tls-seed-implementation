...
-DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS} -DNO_PRINT -DTIME_LOG -fPIC"      \
-DCMAKE_C_FLAGS="${CMAKE_C_FLAGS} -DNO_PRINT -DTIME_LOG -fPIC"         \
-DOPENSSL_NO_THREADS=1 -DBUILD_SHARED_LIBS=1     \
-DOPENSSL_NO_ASM=1 -DOPENSSL_TIMELOG=1 ..
...
cp ssl/libssl.so* /home/hwlee/devel/rpi/edge/boringssl/lib64/no_debug

echo "[boringssl] Copy libcrypto.a to export-ta_arm64"
cp crypto/libcrypto.so* /home/hwlee/devel/rpi/edge/boringssl/lib64/no_debug
...
cmake -DCMAKE_TOOLCHAIN_FILE=../util/aarch64-toolchain.cmake  \
-DPERL_EXECUTABLE=/usr/bin/perl -DGO_EXECUTABLE=/usr/bin/go   \
-DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS} -fPIC -DNO_PRINT -DTIME_LOG"      \
-DCMAKE_C_FLAGS="${CMAKE_C_FLAGS} -fPIC -DNO_PRINT -DTIME_LOG"         \
...
echo "[boringssl] Copy libssl.a to export-ta_arm64"
cp ssl/libssl.a /home/hwlee/devel/rpi/edge/boringssl/lib64/no_debug

echo "[boringssl] Copy libcrypto.a to export-ta_arm64"
cp crypto/libcrypto.a /home/hwlee/devel/rpi/edge/boringssl/lib64/no_debug
