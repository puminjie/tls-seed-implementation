...
-DOPENSSL_NO_ASM=1 -DOPENSSL_NO_THREADS=1 -DBUILD_SHARED_LIBS=1 ..

echo "[boringssl] Make"
make

echo "[boringssl] Copy libssl.a to export-ta_arm64"
cp ssl/libssl.so* /home/hwlee/devel/rpi/edge/boringssl/lib64

echo "[boringssl] Copy libcrypto.a to export-ta_arm64"
cp crypto/libcrypto.so* /home/hwlee/devel/rpi/edge/boringssl/lib64
...
echo "[boringssl] Copy libssl.a to export-ta_arm64"
cp ssl/libssl.a /home/hwlee/devel/rpi/edge/boringssl/lib64

echo "[boringssl] Copy libcrypto.a to export-ta_arm64"
cp crypto/libcrypto.a /home/hwlee/devel/rpi/edge/boringssl/lib64
