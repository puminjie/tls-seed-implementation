...
-DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS} -fPIC -DDEBUG -DTIME_LOG"                  \
-DCMAKE_C_FLAGS="${CMAKE_C_FLAGS} -fPIC -DDEBUG -DTIME_LOG"                      \
...
cp ssl/libssl.so* /home/hwlee/devel/rpi/edge/boringssl/lib64/debug

echo "[boringssl] Copy libcrypto.a to export-ta_arm64"
cp crypto/libcrypto.so* /home/hwlee/devel/rpi/edge/boringssl/lib64/debug
...
-DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS} -fPIC -DDEBUG -DTIME_LOG"                  \
-DCMAKE_C_FLAGS="${CMAKE_C_FLAGS} -fPIC -DDEBUG -DTIME_LOG"                      \
-DOPENSSL_NO_ASM=1 -DOPENSSL_NO_THREADS=1 -DBUILD_SHARED_LIBS=0 ..

echo "[boringssl] Make"
make

echo "[boringssl] Copy libssl.a to export-ta_arm64"
cp ssl/libssl.a /home/hwlee/devel/rpi/edge/boringssl/lib64/debug

echo "[boringssl] Copy libcrypto.a to export-ta_arm64"
cp crypto/libcrypto.a /home/hwlee/devel/rpi/edge/boringssl/lib64/debug
...
-DPERL_EXECUTABLE=/usr/bin/perl -DGO_EXECUTABLE=/usr/bin/go   \
-DCMAKE_CXX_FLAGS="-fPIC -DTIME_LOG -DDEBUG"                  \
-DCMAKE_C_FLAGS="-fPIC -DTIME_LOG -DDEBUG"                      \
...
cp ssl/libssl.so* crypto/libcrypto.so* /home/hwlee/devel/rpi/edge/boringssl/lib64_x86_64/debug
